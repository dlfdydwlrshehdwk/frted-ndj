...
/************************************************** 
    ...
    예시코드 )
        ...
        [ 뷰엑스 스토어 버전이슈 ]
        - 일반적으로 뷰JS 버전이 2.x 이면 vuex는 3.x 버전을 사용
        (예컨대 최신 뷰는 3.x이므로 vuex는 4.x버전을 씀)
        -> 메이저버전 숫자가 뷰보다 하나크다!

...
/**************************************************** 
    ...
    - appendChild() 메서드 없이 DOM에 요소 넣기가 가능하다.
****************************************************/
...
// 리액트 루트 생성하기 : createRoot() 메서드사용
const root1 = 
ReactDOM
.createRoot(document.querySelectorAll('#root>div')[0]);
// 적용하기 : 생성된 루트에 render() 메서드를 붙여서 사용한다.
root1.render(myele1);

// (2) JSX를 사용하지 않는 방법 // 
// 넣을 요소를 createElement() 메서드로 생성해야 함(JSX를 쓰지않고...)
...
const myele6 = <input type="text" value="홀로태그는 스스로 닫자!" />
...
/**************************************************** 
    ...
    <태그 class="클래스명">
    class는 JS에서 키워드이므로 사용불가
    대신 ... <태그 className="클래스명"> 사용
****************************************************/

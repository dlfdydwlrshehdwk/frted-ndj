...
function Car(props){
    ...
    // 컴포넌트에 전달하는 props는 하나로 여러개 사용가능!
    // 사용법 : props.속성명
    return (
        <React.Fragment>
...
// 위의 두가지 차소개 컴포넌트를 하위 컴포넌트로 구성하여 새로운 자동차
// 브랜드 소개 질문 답변형 컴포넌트를 새롭게 구성한다.
function Brand(){
    return (
        <React.Fragment>
            <h1>당신의 차는 무슨차죠?</h1>

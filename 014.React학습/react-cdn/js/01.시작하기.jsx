// 01. 시작하기 리액트 JS
/* 
    html 태그와 JS문법을 따옴표 없이 사용하는 JSX문법을 사용
    JSX(Javascript XML) 문법을 쓰는 파일은 .js 대신 .jsx확장자를 사용
    -> return 키워드 사용은 따옴표없이 바로 소괄호를 묶어사용(소괄호 생략가능)

    [[ 주의사항 ]]
    1. 함수를 만들경우 반드시 대문자로 시작해야 호출됨(정해진규칙)
    2. 홀로태그를 사용할때는 마지막에 스스로 닫기를 꼭 해줌( />)
    3. 함수 내부의 리턴값으로 만든 요소는 반드시 최상위요소가 하나여야한다.
*/

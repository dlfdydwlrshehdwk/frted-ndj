// JS로 구현한 자동페이지 휠 JS - jquery-Hrscroll.js
...
// 페이지번호 대신 이동단위 - 기본 200px 만큼 갈거라는 소리
const unit_sc = 200;

// 스크롤 횟수 한계값 : 화면 가로폭 * 페이지수
let limit_sc = $('body').width() * 7;
console.log(limit_sc);
...
function movePg(){
    ...
    $('html,body')
    .stop()
    .animate({ // 가로스크롤 이동이므로 scrollLeft
        // 가로스크롤 이동 기준은 윈도우width 이다. 
        scrollLeft : 
        ($(window).width() *pno)+'px'

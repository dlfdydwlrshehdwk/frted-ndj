    ...
    ***********************************/
    ...
    .click(function(){
        let fn = () => {// 콜백함수); ///// fadeIn ////////////
            ...
            msg.html(`여긴없겠지?`)
            .fadeIn(200)
            .delay(1000) // 1초지연(애니앞에서)
            .fadeIn(200,()=>{
                // 두번째 메시지
                msg.html(`그래도 무서우니<br> 윗층으로가자!`)
    ...
    .click(function(){
        let fn = () => {// 콜백함수); ///// fadeIn ////////////
            ...
            .css({
                ...
                transition:'.5s .5s', // 0.5초 0.5초후 애니
            ...
            setTimeout(()=>{
                ...
                .css({filter : 'grayscale(0)'}); // 컬러로

                // 대사
                msg.html(`곧 탈출할 수 있을거야!`)
                .fadeIn(200);
